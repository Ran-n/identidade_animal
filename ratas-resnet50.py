...
#------------------------------------------------------------------------------------------------
#+ Autor:   Ran#
#+ Creado:  21/04/2021 18:24:58
#+ Editado:	26/07/2021 13:14:11
#------------------------------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    NOMENCLATURA = 'dataset-ratas-resnet50_'+nomenclar(ALTURA_IMAXE)+';epochs_'+nomenclar(EPOCHS)+';batch-size_'+nomenclar(BATCH_SIZE)+';semente_'+nomenclar(SEMENTE)+'___'+str(secrets.token_hex(4))
    CARPETA = 'saidas/ratas_resnet50/'+NOMENCLATURA
