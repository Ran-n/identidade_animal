...
def main():
	...
	gardar_csv(fich_saida+'_ratas.csv', contido_csv_ratas)
	...
	for fich in ficheiros_cascudas:
		...
		if linha_csv_ratas[0] == 'inceptionv3':
			linha_csv_150_cascudas = linha_csv.copy()
			...
			linha_csv_224_cascudas = linha_csv.copy()
		...
		linha_csv_256_cascudas = linha_csv.copy()
	...
	# gardamos o contido no ficheiro
	gardar_csv(fich_saida+'_cascudas.csv', contido_csv_cascudas)
