...
if __name__=='__main__':
    ...
    NOMENCLATURA = 'dataset-cascudas-inceptionv3_'+nomenclar(ALTURA_IMAXE)+';epochs_'+nomenclar(EPOCHS)+';batch-size_'+nomenclar(BATCH_SIZE)+';semente_'+nomenclar(SEMENTE)+'___'+str(secrets.token_hex(4))
    CARPETA = 'saidas/cascudas_inceptionv3/'+NOMENCLATURA
    ...
    cronoloxia = {
        ...
        'Dataset 150':{'gregor': {'cronoloxía': [], 'confianza': []},
                      'grete':   {'cronoloxía': [], 'confianza': []},
                      'samsa':   {'cronoloxía': [], 'confianza': []}
                        },
    ...
    for dataset in ['32', '64', '128', '150', '256']:
